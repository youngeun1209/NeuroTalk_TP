...
class myDataset(Dataset):
    def __init__(self, args, mode, data="./", task = "SpokenEEG", recon="Y_mel"):
        ...
        self.lenth = 780 #len(os.listdir(self.savedata + '/train/audio/')) #780 # the number data
        self.lenthtest = 260 #len(os.listdir(self.savedata + '/test/audio/')) #260
        self.lenthval = 260 #len(os.listdir(self.savedata + '/val/audio/')) #260
